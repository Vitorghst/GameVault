  ...
  return (
    <div className="game-card-rawg" onClick={onClick}>
      <div className="game-card-image-container">
        <img 
          src={game.cover || game.background_image || 'https://via.placeholder.com/300x400?text=No+Image'} 
          alt={game.name}
        ...
        {/* Overlay com rating */}
        {game.metacritic && (
          <div className="game-rating-badge" style={{
      ...
      <div className="game-card-content">
        ...
        {game.released && (
          <div className="game-meta">
            ...
            {game.genres && <span className="game-genre">{game.genres[0]?.name}</span>}
          </div>
        )}

        {/* Stats da coleção do usuário */}
        {!isSearchResult && (
          <div className="game-stats-rawg">
            {game.hoursPlayed > 0 && (
              <div className="stat-item-rawg">
            ...
            {game.personalRating > 0 && (
              <div className="stat-item-rawg">
                ...
                <span>{game.personalRating}/10</span>
              </div>
            )}
          </div>
        )}
